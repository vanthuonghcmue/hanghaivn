...
* Compatibility update with new MailerLite API

= 2.2.2 =

Released on: 26th April, 2023
...
Released on: 1st August, 2022

Enhancements:

* Sendinblue contacts addition in multiple lists support added
...
* Sendinblue multiple lists support added
