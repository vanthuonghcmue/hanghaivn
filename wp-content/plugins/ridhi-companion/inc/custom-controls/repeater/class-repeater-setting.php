<?php
/**
 * Ridhi Companion Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Ridhi_Companion_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Ridhi_Companion_Repeater_Setting extends WP_Customize_Setting {
