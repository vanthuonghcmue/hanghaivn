<?php
/**
 * Ridhi Customizer Slider Control.
 * 
 * @package Ridhi
*/
...
if ( ! class_exists( 'Ridhi_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Ridhi_Slider_Control extends WP_Customize_Control {

		public $type = 'ridhi-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'ridhi-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'ridhi-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
